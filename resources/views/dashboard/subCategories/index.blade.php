...
@section('content')
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($subCategories as $subCategory)
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="editSubCategoryModalLabel{{ $subCategory->id }}">تعديل التصنيف
                                                        الفرعي</h5>
                                    ...
                                    <div class="modal fade" id="deleteSubCategoryModal{{ $subCategory->id }}"
                                        tabindex="-1" role="dialog"
                                        aria-labelledby="deleteSubCategoryModalLabel{{ $subCategory->id }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="deleteSubCategoryModalLabel{{ $subCategory->id }}">حذف التصنيف
                                                        الفرعي</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                ...
                                                <form action="{{ route('subCategories.destroy', $subCategory->id) }}"
                                                    ...
                                                    @method('DELETE')
                                                    <div class="modal-body">
                                                        <p>هل أنت متأكد من أنك تريد حذف هذا التصنيف الفرعي؟</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
    ...
    <div class="modal fade" id="addSubCategoryModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addSubCategoryModalLabel">إضافة تصنيف فرعي جديد</h5>
